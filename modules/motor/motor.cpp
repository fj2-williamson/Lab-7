...
static bool motorEventFlag = false;
...
//=====[polling functions]======================================================
void motorPollEventInit(){
    motorSensor.mode(PullUp);
    motorEventFlag = false;
}

bool motorEventFlagRead(){
    return motorEventFlag;
}

void motorEventFlagClear(){
    motorEventFlag = false;
    }
...
void motorControlUpdate()
{
    ...
    motorDirectionWrite(DIRECTION_2);
     ...
     else motorDirectionWrite(DIRECTION_1);
     motorEventFlagClear();
    }
